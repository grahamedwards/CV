...
\begin{itemize} 
	...
	\item Handling, inventorying, and testing (dosimetry) various radionuclide tracers and standards for mass spectrometric analyses:  $^{202}$Pb, $^{205}$Pb, $^{229}$Th, $^{230}$Th, $^{232}$Th, $^{233}$U, $^{235}$U, $^{236}$U, $^{238}$U
