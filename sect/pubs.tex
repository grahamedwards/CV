...
\begin{etaremune} [itemsep=4pt, leftmargin=3ex]
    ...
    \item B.~De Sanctis, N.B.~Dragone, C.~Wanket, C.P.~Bueno de Mesquita, S.~Crump, G.~Piccione, B.~Nirula, H.~Bender, R.~Corbett-Detig, E.T.~Rasbury, \ghedwards, A.~Hawthorn, J.J.~Welch, A.~Rouillard, B.~Shapiro, J.~Mikucki, T.~Blackburn. Ancient metagenomics reveals subglacial microbiomes driven by oxygen availability. \inreview{Nature}. Preprint: \doi{10.64898/2025.12.03.692186}.\TUpubpct{5}

    \item R.~Rampalli*, J.W.~Johnson, M.K.~Ness, \ghedwards, E.R.~Newton, E.J.~Griffith, M.~Bedell, K.~Wang. A galactic perspective on the (unremarkable) relative refractory depletion observed in the Sun. \inreview{The Astrophysical Journal}. \arxiv{2509.03577}.\TUpubpct{5}
